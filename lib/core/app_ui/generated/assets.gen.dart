...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [appleIc, googleIc];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/app_logo_img.png
  AssetGenImage get appLogoImg =>
      const AssetGenImage('assets/images/app_logo_img.png');

  /// File path: assets/images/app_logo_splash_img.svg
  SvgGenImage get appLogoSplashImg =>
      const SvgGenImage('assets/images/app_logo_splash_img.svg');

  /// File path: assets/images/chat_up_img.svg
  SvgGenImage get chatUpImg =>
      const SvgGenImage('assets/images/chat_up_img.svg');

  /// File path: assets/images/dot_img.svg
  SvgGenImage get dotImg => const SvgGenImage('assets/images/dot_img.svg');

  /// File path: assets/images/join_peers_img.svg
  ...
  SvgGenImage get splashImg =>
      const SvgGenImage('assets/images/splash_img.svg');
...
abstract final class Assets {
  static const String package = 'chat_up';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/chat_up/$_assetName';
}
